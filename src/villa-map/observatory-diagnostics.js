...
export const OBSERVATORY_DIAGNOSTIC_VIEWS = Object.freeze({
  ...
  "mushroom-window-east": Object.freeze({ position: [1.5, 3.0, 23.5], target: [-3.1, 2.8, 20.8] }),
  "mushroom-window-west": Object.freeze({ position: [-13.5, 3.0, 23.5], target: [-8.9, 2.8, 20.8] }),
  "dog-house": Object.freeze({ position: [-13.8, 2.2, 27.5], target: [-19, 1.0, 24] }),
