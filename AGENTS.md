...
| `mushroom-interior.js` | Procedural three-storey round-tower interior plus player-scale fairy-light/bunting canopies and the node-pure fallback dome for the real-sky texture; node-pure like `assets.js` |
